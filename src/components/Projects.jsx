...
const Projects = () => {
  return (
    <section className="py-10 px-4"> {/* Changed py-12 to py-10 */}
      <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">My Projects</h2>
      <div className="max-w-4xl mx-auto grid gap-8 md:grid-cols-2">
        {projectsData.map((project) => (
          <div key={project.name} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="flex justify-start space-x-4">
              ...
              {project.live_url && project.live_url !== "Not available" && project.live_url !== "" && (
                <a
